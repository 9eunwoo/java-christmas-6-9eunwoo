...
## 📖 프로젝트 개요
"크리스마스 프로모션"은 크리스마스 시즌을 맞이하여 다양한 음식 메뉴를 할인된 가격에 제공하는 프로모션 이벤트 애플리케이션입니다. 사용자는 특정 날짜를 선택하여 메뉴를 주문할 수 있으며, 다양한 할인 정책과 이벤트 혜택을 받을 수 있습니다. 프로모션은 할인 금액 계산, 증정 메뉴 제공, 특별 이벤트 배지 부여 등의 기능을 포함하며, 크리스마스 기간 동안 고객에게 특별한 경험을 제공하기 위해 설계되었습니다.
